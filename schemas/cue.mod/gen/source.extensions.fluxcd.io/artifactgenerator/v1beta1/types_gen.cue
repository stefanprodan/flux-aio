...
//timoni:generate timoni mod vendor crd -f https://github.com/fluxcd/flux2/releases/download/v2.9.4/install.yaml
...
#ArtifactGeneratorSpec: {
	...
	artifacts!: list.MaxItems(1000) & [...{
		...
		copy!: [...{
			...
			exclude?: list.MaxItems(100) & [...strings.MaxRunes(1024)]
