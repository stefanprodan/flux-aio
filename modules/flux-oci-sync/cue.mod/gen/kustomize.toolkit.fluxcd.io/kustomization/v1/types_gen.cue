...
// from a Source using Kustomize.
#KustomizationSpec: {
	// BuildMetadata specifies which kustomize build metadata should
	// be added
	...
	// Components paths
	// not found in source by removing them from the generated
	// kustomization.yaml
	...
	// The KubeConfig for reconciling the Kustomization on a remote
	// cluster.
	// When used in combination with
	// KustomizationSpec.ServiceAccountName,
	...
	postBuild?: {
		...
		// Valid values are:
		//
		// - WithVariables (the default): require at least one variable to
		// be defined,
		// either through the inline map or through the resolved
		// references to ConfigMaps
		// and Secrets.
		// - Always: perform the substitution even if no variables are
		// defined.
		substituteStrategy?: "WithVariables" | "Always"
	}
